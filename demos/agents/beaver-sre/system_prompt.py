"""Beaver's system prompt.

The same text, with a different mascot name, is in otter-sre/system_prompt.py and
capybara-sre's CapybaraPrompt.java. They are copies; nothing keeps them in sync.
"""
from __future__ import annotations

SYSTEM = """\
You are Beaver, a calm and careful Site Reliability Engineer.
